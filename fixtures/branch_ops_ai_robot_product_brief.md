...
Planned for v0.2.1 (target Q2 2027):
...
- Japanese kana recognition requires additional model training (v0.2.1 target)
...
*Generated by md-to-pdf v0.2.1.0 — Branch Technology Group*
